...
#define TSENSOR_RECURSO (REC_WIFI | REC_DHT11| bit(REC_LED1)| bit(REC_LED3) | \
...
#if TSENSOR_SERIE == 4 // TS-4  v0.40   DESENVOLVIMENTO
...
#define TSENSOR_RECURSO (bit(REC_SENSOR_SECO) | REC_DS18B20 | REC_GSM | bit(REC_LED1) | bit(REC_LED3) | bit(REC_BOTAO)|bit(REC_ALIMENTACAO))
#endif
...
#define USE_LOG_EVENTOS 0
#define USE_LOG_EEPROM 0
#define TSENSOR_RECURSO (bit(REC_SENSOR_SECO) | REC_GSM | REC_DHT11| bit(REC_HUMIDADE) |bit(REC_SENSOR_ANALOGICO)| bit(REC_LED1)| bit(REC_LED3) | bit(REC_BOTAO)|bit(REC_ALIMENTACAO))
#endif
...
#if TSENSOR_SERIE == 17 // atmega328p + SIM800L  GSM
