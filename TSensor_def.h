...
#undef HAS_SENSOR_ANALOGICO 0
#define HAS_SENSOR_ANALOGICO 1
#define SENSOR_ANALOGICO_PIN A1
#define SENSOR_ANALOGICO_PIN_2 0
#define HAS_SENSOR_SECO 1
#define TSENSOR_RECURSO (REC_DS18B20 | bit(REC_WIFI) | \
		bit(REC_SENSOR_SECO) | bit(REC_LED1) |bit(REC_LED3) | bit(REC_BOTAO)|bit(REC_ALIMENTACAO))
#endif
...
#define TSENSOR_RECURSO (bit(REC_SENSOR_SECO) | bit(REC_ETHERNET) | REC_DHT11| \
bit(REC_HUMIDADE) | bit(REC_LED1)| bit(REC_LED3) | bit(REC_BOTAO)|bit(REC_ALIMENTACAO))
#endif
...
#undef HAS_SENSOR_ANALOGICO
#undef HAS_SENSOR_SECO
//#define HAS_ETH 0
//#define DEBUG 10
// hw tem DS18B20 no A0 em curto
#define HAS_BLUETOOTH 0
#define HAS_DS18B20 1
#define B_TEMPERATURA bit(B_PORTA_A0)  | 0b0110 // porta A0
#define CALIBRAGEM_CORRENTE 0xb000  // A2=30A   e A1,A0=30A   60.6 -> 100A   30.0 -> 30A
#undef HAS_DHT11
#undef HAS_HUMIDITY
#define HAS_CORRENTE 1
#define MAX_CORRENTE_FASES 3
#define TEMPO_COLETA_CORRENTE 10
#define TSENSOR_RECURSO (REC_DS18B20 | bit(REC_ETHERNET)| \
bit(REC_CORRENTE_30A) | bit(REC_LED1) |bit(REC_LED3) | bit(REC_BOTAO)|bit(REC_ALIMENTACAO))
...
#define HAS_SENSOR_SECO 1
#define TSENSOR_RECURSO (bit(REC_ETHERNET) | REC_DHT11| bit(REC_SENSOR_SECO) | \
		bit(REC_LED1)| bit(REC_LED3) | bit(REC_BOTAO)|bit(REC_ALIMENTACAO))
#endif
